...
const normalizeStatsEligibilityOverrides = (value?: StatsEligibilityOverrides | null): StatsEligibilityOverrides => {
  ...
  const turns = Object.fromEntries(
    Object.entries(value.turns ?? {}).flatMap(([turnKey, modes]) => {
